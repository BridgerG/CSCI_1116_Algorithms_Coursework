...
//    
  ...
  public static class BST<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public void nonRecursiveInorder() {
      ...
      while(stack.get(i).left != null || stack.get(i).right != null) {
    	  
    	 if(stack.get(i).right != null) {
    		 
    		 stack.add(stack.get(i).right);
    		 
    	 }
    	 
    	 if(stack.get(i).left != null) {
    		 
    		 stack.add(stack.get(i).left);
