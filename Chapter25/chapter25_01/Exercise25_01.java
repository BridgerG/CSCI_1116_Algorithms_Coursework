...
public class Exercise25_01 {
  ...
  public Exercise25_01() {
    ...
    BinaryTree<String> tree1 = new BinaryTree<String>(new String[] {"Tom", "George", "Jean", "Jane", "Kevin", "Peter", "Susan", "Jen", "Kim", "Michael", "Michelle"});
  ...
  public class BinaryTree<E extends Comparable<E>> extends AbstractTree<E> {
    ...
    public int height(TreeNode<E> a) {
